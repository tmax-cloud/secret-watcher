...
public class CertSecretWatcher extends Thread {
    final static Logger logger = LoggerFactory.getLogger(CertSecretWatcher.class);
    ...
    CertSecretWatcher(ApiClient client, CoreV1Api api, int resourceVersion) throws Exception {
        ...
        this.client = client;
        try {
            this.watch = Watch.createWatch(client,
                    api.listSecretForAllNamespacesCall(null,
                            null, null, "secret=cert", null, null,
            ...
            while (true) {
                ...
                try {
                    watch = Watch.createWatch(
                            client,
                            api.listSecretForAllNamespacesCall(null, null, null, "secret=cert", null, null, null, null, null, null, null),
                            new TypeToken<Watch.Response<V1Secret>>() {
                            }.getType()
                    );
                } catch (ApiException e) {
